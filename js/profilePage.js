...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('name').textContent = userAccount.name || 'Not Provided';
    document.getElementById('email').textContent = userAccount.email || 'Not Provided';
    document.getElementById('age').textContent = userAccount.age || 'Not Provided';
    document.getElementById('gender').textContent = userAccount.gender || 'Not Provided';
    document.getElementById('country').textContent = userAccount.country || 'Not Provided';
